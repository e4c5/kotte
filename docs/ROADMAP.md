...
- Wiring the migration chain into the B1.3 integration job so the service container starts with `alembic upgrade head` applied — tracked under B1.3.
...
- [~] **B1** — GitHub Actions: `backend-ci.yml` (PR #37 on `feat/b1-b2-ci-tests-and-lint`, bundled with B2; lint=ruff/black and unit jobs shipped, sub-tickets B1.2/B1.3 below)
